...
Make_plot_df <- function(anno1, anno2, TPM, colname_of_WT_scale_TPM){
  ...
  #Assign SE associated genes with their RNA-seq scaled TPM.
  ...
  #Remove genes whose expressions were not detected in RNA-seq
...
#Specify the column name of variable 'TPM' of scaled TPM of WT cells 
#at argument 'colname_of_WT_scale_TPM'.
